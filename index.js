...
/**
        ...
        const FunfactsPanel = {
          name: 'FunfactsPanel',
          template: '<div class="funfacts-panel"><div class="vue-card panel-card" style="--i:0"><div class="vue-card-title">🐙 章鱼有三颗心脏</div><div class="vue-card-desc">章鱼拥有三颗心脏：一颗主心脏将血液输送到全身，两颗鳃心将血液泵入鳃部。游泳时主心脏会停止跳动。</div><div class="vue-tag-row"><span class="vue-tag">生物</span><span class="vue-tag">海洋</span></div></div><div class="vue-card panel-card" style="--i:1"><div class="vue-card-title">⚡ 闪电温度比太阳表面还高</div><div class="vue-card-desc">一道闪电可达 30,000°C，是太阳表面（约 5,500°C）的五倍以上，能瞬间将空气中的氮气转化为植物可吸收的氮化物。</div><div class="vue-tag-row"><span class="vue-tag">自然</span><span class="vue-tag">气象</span></div></div><div class="vue-card panel-card" style="--i:2"><div class="vue-card-title">🍌 香蕉具有放射性</div><div class="vue-card-desc">香蕉富含钾元素，约 0.01% 是放射性钾-40。需一口气吃约 1000 万根才达致死剂量——远早于辐射伤害前就会先撑死。</div><div class="vue-tag-row"><span class="vue-tag">科学</span><span class="vue-tag">食物</span></div></div><div class="vue-card panel-card" style="--i:3"><div class="vue-card-title">🏔️ 珠峰每年长高 4 毫米</div><div class="vue-card-desc">印度板块持续挤压欧亚板块，喜马拉雅山脉仍在缓慢抬升，珠峰每年约增高 4 毫米——差不多是指甲生长的速度。</div><div class="vue-tag-row"><span class="vue-tag">地理</span><span class="vue-tag">地质</span></div></div><div class="vue-card panel-card" style="--i:4"><div class="vue-card-title">💡 百年灯泡还在亮</div><div class="vue-card-desc">加州利弗莫尔消防站的灯泡自 1901 年安装以来几乎从未熄灭，已亮了超 120 年。它是一枚手工碳丝灯泡，功率仅 4 瓦。</div><div class="vue-tag-row"><span class="vue-tag">历史</span><span class="vue-tag">发明</span></div></div><div class="vue-card panel-card" style="--i:5"><div class="vue-card-title">🐝 蜜蜂能识别人脸</div><div class="vue-card-desc">蜜蜂可通过排列组合识别人脸特征，就像识别花朵图案一样。蜂群还能通过跳舞传递精确的导航信息。</div><div class="vue-tag-row"><span class="vue-tag">动物</span><span class="vue-tag">研究</span></div></div></div>'
        };
        ...
        if (typeof Vue !== 'undefined') {
                ...
                data() {
                    return {
                        ...
                        tabs: [
                            ...
                            { id: 2, name: '技能领域' },
                            { id: 3, name: '联系方式' },
                            { id: 4, name: '个人简历' }, { id: 5, name: '灵感墙' }, { id: 6, name: '工具箱' }, { id: 7, name: '技术百科' }, { id: 8, name: 'Code Lab' }, { id: 9, name: '奇闻趣事' },
                        ],
                    };
                },
                computed: {
            ...
            if (typeof FunfactsPanel !== 'undefined') app.component('funfacts-panel', FunfactsPanel);
