...
/**
        ...
        const DesignPanel = {
          name: 'DesignPanel',
          template: '<div class="design-panel"><div class="vue-card panel-card" style="--i:0"><div class="vue-card-title">色彩系统</div><div class="color-grid"><div class="color-swatch" style="background:#0a0505"><span>bg-deep</span><small>#0a0505</small></div><div class="color-swatch" style="background:#882222"><span>red-dark</span><small>#882222</small></div><div class="color-swatch" style="background:#b43838"><span>red-mid</span><small>#b43838</small></div><div class="color-swatch" style="background:#c84040"><span>red-bright</span><small>#c84040</small></div><div class="color-swatch" style="background:#e08080"><span>red-light</span><small>#e08080</small></div><div class="color-swatch" style="background:#f0d8d8"><span>red-pale</span><small>#f0d8d8</small></div></div></div><div class="vue-card panel-card" style="--i:1"><div class="vue-card-title">字体排版</div><div class="type-sample"><div class="type-row"><span class="type-label">标题</span><span class="type-demo" style="font-size:28px">VT323 28px</span></div><div class="type-row"><span class="type-label">正文</span><span class="type-demo" style="font-size:15px">VT323 15px</span></div><div class="type-row"><span class="type-label">辅助</span><span class="type-demo" style="font-size:11px">VT323 11px</span></div><div class="type-row"><span class="type-label">间距</span><span class="type-demo" style="letter-spacing:3px">letter-spacing 1.5-4px</span></div></div></div><div class="vue-card panel-card" style="--i:2"><div class="vue-card-title">毛玻璃层级</div><div class="glass-stack"><div class="glass-layer" style="backdrop-filter:blur(6px)"><span>轻度模糊 6px</span></div><div class="glass-layer" style="backdrop-filter:blur(14px)"><span>中度模糊 14px</span></div><div class="glass-layer" style="backdrop-filter:blur(22px)"><span>重度模糊 22px</span></div></div></div></div>'
        };
        ...
        if (typeof Vue !== 'undefined') {
                ...
                data() {
                    return {
                        ...
                        tabs: [
                            ...
                            { id: 2, name: '技能领域' },
                            { id: 3, name: '联系方式' },
                            { id: 4, name: '个人简历' }, { id: 5, name: '灵感墙' }, { id: 6, name: '工具箱' }, { id: 7, name: '设计规范' },
                        ],
                    };
                },
                computed: {
            ...
            if (typeof DesignPanel !== 'undefined') app.component('design-panel', DesignPanel);
